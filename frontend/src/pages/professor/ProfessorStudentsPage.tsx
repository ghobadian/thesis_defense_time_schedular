...
export const ProfessorStudentsPage: React.FC = () => {
    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center h-64">
                <div className="text-gray-600">{t("loading_students")}</div>
            </div>);
    ...
    if (error) {
        return (
            <Card>
                <p className="text-red-600 text-center py-8">{t("failed_to_load_students_please_try_again_later")}
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold text-gray-900">{t("my_students")}</h1>
                <div className="text-sm text-gray-600">{t("total")}
            ...
            {!students || students.length === 0 ?
                <Card>
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 text-lg">{t("no_students_assigned_yet")}</p>
                        <p className="text-gray-500 text-sm mt-2">{t("students_will_appear_here_when_they_are_assigned_t")}
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">{t("id")}
                                ...
                                {student.thesisForms && student.thesisForms.length > 0 &&
                                    <div className="pt-4 border-t border-gray-200">
                                        <div className="flex items-center space-x-2 mb-2">
                                            ...
                                            <span className="text-sm font-medium text-gray-700">{t("thesis_forms")}
                                                {student.thesisForms.length})
                                            </span>
                                        </div>
