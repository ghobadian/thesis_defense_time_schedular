            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="bg-blue-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-blue-600 text-sm font-medium">{t("total_forms")}</p>
                ...
                <Card className="bg-green-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-green-600 text-sm font-medium">{t("approved")}</p>
                ...
                <Card className="bg-purple-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-purple-600 text-sm font-medium">{t("meetings")}</p>
                    ...
                    {thesisForms?.slice(0, 3).map((form: ThesisForm) =>
                            <div key={form.id} className="flex items-center justify-between py-3 border-b">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">{t("submitted_on")}
