...
export const AdminHomePage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="bg-blue-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-blue-600 text-sm font-medium">{t("total_students")}</p>
                ...
                <Card className="bg-purple-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-purple-600 text-sm font-medium">{t("total_professors")}</p>
                            <p className="text-3xl font-bold text-gray-900">
                                {loadingStats ? '...' : stats?.totalProfessors || 0}
                            </p>
                            <p className="text-xs text-purple-600 mt-1">
                                {stats?.activeProfessors || 0}{t("active_this_month")}
                            </p>
                        </div>
                ...
                <Card className="bg-green-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-green-600 text-sm font-medium">{t("thesis_forms")}</p>
                            <p className="text-3xl font-bold text-gray-900">
                                {loadingStats ? '...' : stats?.totalThesisForms || 0}
                            </p>
                            <p className="text-xs text-green-600 mt-1">
                                {stats?.pendingForms || 0}{t("pending_review")}
                            </p>
                        </div>
                ...
                <Card className="bg-yellow-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-yellow-600 text-sm font-medium">{t("defense_meetings")}</p>
                            <p className="text-3xl font-bold text-gray-900">
            ...
            <Card title={t("department_overview")}>
                <div className="space-y-4">
                    {loadingDepartments ?
                        <div className="text-center py-8 text-gray-600">{t("loading_departments")}</div> :
                            ...
                            {departments?.map((dept: DepartmentDetail) =>
                                <div
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">{t("professors")}</span>
                                            <span
                                        ...
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">{t("active_thesis")}</span>
                                            <span
            ...
            <Card title={t("system_health")}>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900">{t("system_status")}</h3>
                        <p className="text-green-600 font-medium">{t("operational")}</p>
                    </div>
                    <div className="text-center">
                        <div
                        ...
                        <h3 className="text-lg font-semibold text-gray-900">{t("active_sessions")}</h3>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900">{t("system_load")}</h3>
                        <p className="text-green-600 font-medium">{t("normal")}</p>
                    </div>
                </div>
            </Card>
        </div>);
