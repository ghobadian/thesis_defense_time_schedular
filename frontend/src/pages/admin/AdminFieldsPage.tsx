    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">{t("fields_management")}</h1>
                    <p className="text-gray-500 text-sm mt-1">{t("manage_study_fields_and_their_department_associati")}</p>
                </div>
                <button
                    ...
                    <Plus className="h-4 w-4"/>{t("add_new_field")}
            ...
            {isLoadingFields ?
                ...
                filteredFields.length === 0 ?
                    <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                        ...
                        <h3 className="text-lg font-medium text-gray-900">{t("no_fields_found")}</h3>
                        <p className="text-gray-500 mt-1">{t("try_adjusting_your_filters_or_add_a_new_field")}</p>
                    </div> :
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">{t("field_name")}
                                ...
                                <input
                                    ...
                                    placeholder={t("eg_software_engineering")}
