...
public class ProfessorMeetingController {
    ...
    @PostMapping("/give-time-range")
    public ResponseEntity<?> specifyAvailableTimeRange(@RequestBody AvailableTimeRangeInputDTO availableTimeInputDTo) {
        service.specifyAvailableTime(availableTimeInputDTo);
        return ResponseEntity.ok("Time slot added");
    }
